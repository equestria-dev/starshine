...
<div class="container" id="language-container">
    ...
    <div id="language-grid">
        <?php $list = scandir($_SERVER['DOCUMENT_ROOT'] . "/includes/lang"); foreach ($list as $item): if (!str_starts_with($item, ".") && str_ends_with($item, ".json") && $item !== "package.json" && $item !== "package-lock.json"): ?>
        <div>
