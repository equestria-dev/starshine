...
<div class="container" id="legal-container">
    <div id="legal-container-inner">
        ...
        <p><?= l("lang.legal.notices.webmasters.1") ?> Mia Raindrops (<a class="legal-link" href="mailto:raindrops@equestria.dev">raindrops@equestria.dev</a>). <?= l("lang.legal.notices.webmasters.2") ?></p>

        <h3><?= l("lang.legal.notices.servers") ?></h3>
        <p><?= l("lang.legal.notices.locations") ?></p>
        <ul>
            <li class="legal-location">
                <b><?= l("lang.legal.notices.property") ?></b> Mia Raindrops (<a class="legal-link" href="mailto:raindrops@equestria.dev">raindrops@equestria.dev</a>)<br>
        ...
        <p><?= l("lang.legal.notices.pgp") ?><code>AEA7 73DB 0620 C57C FFB0 7A91 EFBD C684 35A5 74B7</code> (<a href="/pubkey" target="_blank" class="legal-link"><?= l("lang.legal.notices.key") ?></a>, <a href="https://github.com/RaindropsSys.gpg" target="_blank" class="legal-link"><?= l("lang.legal.notices.alt") ?></a>).</p>
